                ...
                <div className="flex-1 py-1">
                  ...
                  <div className="flex justify-between items-end mt-2">
                    <div className="flex items-center gap-2">
                      <button onClick={() => decrementQuantity(item.id, item.size, item.color)} className="p-1 border border-border/20" type="button"><Minus className="size-3" /></button>
                      <span className="text-[10px] font-bold">{item.quantity}</span>
                      <button onClick={() => incrementQuantity(item.id, item.size, item.color)} className="p-1 border border-border/20" type="button"><Plus className="size-3" /></button>
                    </div>
